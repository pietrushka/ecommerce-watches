      ...
      <div className='grid gap-5 px-10 py-8 ' >
        ...
        <div className='bg-white rounded-lg shadow-lg'>
          <div className='relative p-2'>
            ...
            <Link href='/product/seiko'>
              <a>
                <h1 className='block text-lg text-2xl cursor-pointer'>Seiko Pepsi</h1>
              </a>
            </Link>


            <button className='inline-block w-6 h-6 my-2 mr-4 bg-blue-700 rounded-full cursor-pointer'></button>
            <button className='inline-block w-6 h-6 my-2 mr-4 bg-black rounded-full cursor-pointer'></button>
            <button className='inline-block w-6 h-6 my-2 mr-4 bg-gray-600 rounded-full cursor-pointer'></button>
        ...
        <div className='bg-white rounded-lg shadow-lg'>
          <div className='relative p-2'>
            ...
            <svg className='absolute top-0 right-0 w-10 mt-2 mr-2 cursor-pointer' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
            </svg>
          </div>

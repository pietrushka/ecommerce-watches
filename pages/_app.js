...
function MyApp({ Component, pageProps }) {
  ...
  return (
    <div className='relative bg-secondary'>
      ...
      <div id='cart' className='fixed bottom-0 z-50 hidden w-11/12 m-4 transition-transform duration-500 ease-out transform translate-y-full bg-white rounded-lg'>
